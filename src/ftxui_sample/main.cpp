...
// configuration step. It creates a namespace called `arro2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", arro2::cmake::project_name, arro2::cmake::project_version) };
